    ...
    <div className="flex-1 overflow-y-auto">
      <article className="mx-auto max-w-[880px] px-6 py-12">
        ...
        <Section number="초록" title="Abstract">
          <p>
            생성형 3D 서비스가 내놓는 삼각형 메시는 화면에서는 닫혀 보입니다. 슬라이서가 요구하는
          ...
          <p>
            ...
            머물고, MeshCap은 {bust?.variants.meshcap.score ?? 100}점에 도달합니다. Meshy 출력 309만
            삼각형은 브라우저에서 약 7초 만에 경계 에지 120개가 0개가 되어 94점에서 96점으로
            올랐습니다. Tripo 190만 삼각형은 97점에서 99점입니다. 표면을 닫으면 이미 면 셋이 공유하던
            에지의 비다양체가 더 심해질 수 있습니다. 채점에서 두 항목을 나눈 이유입니다.
          </p>
        </Section>

        <Section number="1" title="서론">
          <p>
            텍스트나 이미지로 캐릭터를 뽑으면 미리보기에는 충분합니다. 프린터로 보내는 순간이
            다릅니다. 슬라이서는 법선으로 안팎을 보기 때문에, 겨드랑이나 머리카락, 바닥처럼 열린
          ...
          <p>
            ...
            서버에서 돌려 Meshy 309만, Tripo 190만 삼각형 출력물의 경계를 0으로 만들었습니다.
        ...
        <Section number="4" title="실험">
          ...
          <p>
            두 모델 모두 밀폐됩니다. 만점이 아닌 이유도 점수에 남겨 두었습니다. Tripo는 구멍을 메운
            뒤 비다양체 에지가 9개에서 90개로 늘었습니다. 면 셋이 이미 공유하던 자리에 네 번째 면을
            붙인 결과입니다. 표면을 닫는 일과 다양체로 만드는 일이 충돌한 것이고, 채점에서 두 항목을
            갈라 둔 이유입니다.
          </p>
        </Section>
