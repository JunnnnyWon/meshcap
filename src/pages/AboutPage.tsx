      ...
      <div className="mx-auto max-w-[820px] px-6 py-12">
        ...
        <Section title="개인정보 처리">
          <p className="text-[13.5px] leading-relaxed text-ink-300">
            원본 모델 파일은 브라우저를 벗어나지 않습니다. 파일을 여는 것도, 텍스처와 재질을
            버리고 좌표만 남기는 것도 전부 브라우저에서 일어납니다. 기본 설정에서는 계산까지
            브라우저 안에서 끝납니다.
          </p>
          <p className="mt-3 text-[13.5px] leading-relaxed text-ink-300">
            삼각형 50만 개가 넘는 모델은 팀이 운영하는 연산 서버로 보내 처리할 수 있습니다. 이때
            전송되는 것은 좌표 배열과 삼각형 인덱스뿐이고, 서버는 결과를 돌려준 뒤 아무것도
            저장하지 않습니다. 도구 화면의 연산 위치 설정에서 브라우저로 고정할 수 있으며,
            어디에서 처리했는지는 매번 화면에 표시됩니다.
          </p>
          <p className="mt-3 text-[13.5px] leading-relaxed text-ink-300">
            분석 스크립트나 쿠키는 사용하지 않습니다. 서버는 팀이 직접 운영하는 장비이며
            Tailscale 테일넷 안에만 열려 있습니다.
          </p>
        </Section>
